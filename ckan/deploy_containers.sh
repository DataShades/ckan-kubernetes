...
BASE_IMAGE="${REPO_HUB}/ckan-base:base"
TEST_IMAGE="${REPO_HUB}/ckan-base:test"
DEFAULT_IMAGE="${REPO_HUB}/ckan-base:default"
CLIENT1_IMAGE="${REPO_HUB}/ckan-base:client1"
CLIENT2_IMAGE="${REPO_HUB}/ckan-base:client2"
